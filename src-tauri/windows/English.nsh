; IA Usage — NSIS custom language strings (English).
;
...
LangString appRunning ${LANG_ENGLISH} "IA Usage is running! Please close it first then try again."
LangString appRunningOkKill ${LANG_ENGLISH} "IA Usage is running!$\nClick OK to kill it"
...
LangString failedToKillApp ${LANG_ENGLISH} "Failed to kill IA Usage. Please close it first then try again"
