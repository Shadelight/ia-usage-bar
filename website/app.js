const COPY = {
  en: {
    ...
    platformsSubtitle: "The Windows tray app is the flagship. The Android companion and VS Code extension mirror the same provider data.",
    platformCard1t: "Windows",
    platformCard1p: "Tray app with quota panel, compact mode, and spend view. Windows 10/11.",
    platformCard1cta: "Download .exe / .msi",
    platformCard2t: "Android",
    platformCard2p: "Companion app paired by QR code, with a home-screen widget and background refresh.",
    platformCard2cta: "Download APK",
    platformCard3t: "VS Code",
    platformCard3p: "Status bar and tooltip for VS Code and compatible forks (Cursor, Windsurf, Antigravity).",
    platformCard3cta: "Download .vsix",
  ...
  es: {
    ...
    platformsSubtitle: "La app de bandeja para Windows es la principal. El companion Android y la extensión de VS Code reflejan los mismos datos de proveedores.",
    platformCard1t: "Windows",
    platformCard1p: "App de bandeja con panel de cuotas, modo compacto y vista de gasto. Windows 10/11.",
    platformCard1cta: "Descargar .exe / .msi",
    platformCard2t: "Android",
    platformCard2p: "App companion emparejada por código QR, con widget de inicio y refresco en segundo plano.",
    platformCard2cta: "Descargar APK",
    platformCard3t: "VS Code",
    platformCard3p: "Barra de estado y tooltip para VS Code y forks compatibles (Cursor, Windsurf, Antigravity).",
    platformCard3cta: "Descargar .vsix",
